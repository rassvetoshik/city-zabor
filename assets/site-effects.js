(() => {
  ...
  const fenceDetails = {
    ...
    "gate-sliding": {
      ...
      title: "Откатные ворота из профнастила",
      tag: "глухое заполнение",
      ...
      points: [
        "Подходят для приватной въездной группы и забора из профнастила.",
        "Можно сделать одностороннее или двухстороннее заполнение.",
    ...
    "gate-sliding-picket": {
      kicker: "откатные ворота",
      title: "Откатные ворота из евроштакетника",
      tag: "зазор или шахматка",
      image: "./assets/gates-gallery/sliding-picket.jpg",
      imageAlt: "Откатные ворота из евроштакетника",
      gallery: [
        { src: "./assets/gates-gallery/sliding-picket.jpg", alt: "Откатные ворота из металлического штакетника" },
        { src: "./assets/gates-gallery/swing-picket-house.jpg", alt: "Ворота с вертикальным заполнением" },
        { src: "./assets/gates-gallery/sliding-proftruba.jpg", alt: "Откатные ворота на металлическом каркасе" }
      ],
      lead: "Ворота с частичной светопроницаемостью и меньшей ветровой нагрузкой, чем у сплошного профлиста.",
      text: "Евроштакетник можно поставить с зазором или в двухсторонней шахматке. Такой вариант хорошо сочетается с фасадными заборами из штакетника и визуально выглядит легче глухого полотна.",
      specs: [
        ["Проем", "3-4,5 м"],
        ["Высота", "1,5-1,8 м"],
        ["Заполнение", "штакетник"],
        ["Опции", "ручные / автоматические"]
      ],
      points: [
        "Меньше парусность на открытых и ветреных участках.",
        "Можно подобрать шаг ламелей и цвет покрытия.",
        "Подходит для единого комплекта с забором из евроштакетника."
      ],
      included: [
        "Замер проема и проверка места под откат.",
        "Изготовление рамы, направляющей и заполнения штакетником.",
        "Монтаж роликового комплекта, улавливателей и регулировка хода."
      ]
    },
    "gate-swing": {
    ...
    "gate-wicket": {
      ...
      title: "Распашные ворота с калиткой из профнастила",
      tag: "профлист и кирпичные столбы",
    ...
    "gate-wicket-louver": {
      ...
      points: [
        "Закрывает участок от прямого взгляда, но не выглядит как глухая стена.",
        "Хорошо сочетается с забором-жалюзи и современными фасадами.",
        "Требует точной геометрии рамы и аккуратного монтажа ламелей."
      ],
      included: [
    ...
    "gate-sandwich": {
      kicker: "откатные ворота",
      title: "Откатные ворота из сэндвич-панелей",
      tag: "ровное закрытое полотно",
      image: "./assets/catalog-gates.webp",
      imageAlt: "Откатные ворота из сэндвич-панелей",
      gallery: [
        { src: "./assets/catalog-gates.webp", alt: "Откатные ворота из сэндвич-панелей" }
      ],
      lead: "Сэндвич-панели дают ровное непросматриваемое заполнение и современный внешний вид.",
      text: "Полотно собирается на металлическом каркасе, а панели подбираются по цвету и фактуре. Такой вариант уместен для аккуратной въездной группы, где важны строгая поверхность и закрытость участка.",
      specs: [
        ["Проем", "от 3 м"],
        ["Высота", "от 1,5 м"],
        ["Фактура", "по выбору"],
        ["Опции", "калитка / привод"]
      ],
      points: [
        "Ровная поверхность без выраженного профиля.",
        "Можно подобрать цвет под фасад, кровлю или забор.",
        "Подходит для откатной системы с автоматикой."
      ],
      included: [
        "Подбор панелей и расчет веса полотна.",
        "Изготовление рамы и монтаж консольной фурнитуры.",
        "Регулировка хода и подготовка под электропривод."
      ]
    },
    "gate-forged": {
      kicker: "распашные ворота",
      title: "Распашные ворота с декоративным металлом",
      tag: "ковка и решетки",
      image: "./assets/gates-gallery/swing-picket-house.jpg",
      imageAlt: "Распашные ворота с декоративным металлическим заполнением",
      gallery: [
        { src: "./assets/gates-gallery/swing-picket-house.jpg", alt: "Распашные ворота с декоративным заполнением" },
        { src: "./assets/gates-project-arch-stitch.webp", alt: "Декоративные металлические ворота" }
      ],
      lead: "Вариант для фасадной линии, где важны не только функция, но и внешний вид.",
      text: "Заполнение может быть решетчатым, комбинированным или с декоративными элементами. Ковку и металлический рисунок можно повторить в калитке и секциях забора.",
      specs: [
        ["Тип", "распашные"],
        ["Заполнение", "декор / металл"],
        ["Калитка", "в едином стиле"],
        ["Размер", "индивидуально"]
      ],
      points: [
        "Подходит для домов с кирпичными столбами и выразительным фасадом.",
        "Можно сделать более открытый или частично закрытый рисунок.",
        "Для тяжелых створок нужны усиленные столбы и петли."
      ],
      included: [
        "Эскиз заполнения и подбор металла.",
        "Изготовление створок, декоративных элементов и калитки.",
        "Монтаж, окраска и регулировка фурнитуры."
      ]
    },
    "canopy-car": {
    ...
    "canopy-two-cars": {
      ...
      gallery: [
        { src: "./assets/hero-canopy-evening.jpg", alt: "Навес на две машины у частного дома" },
        { src: "./assets/portfolio-canopy-blue.jpg", alt: "Широкий металлический навес для автомобилей" },
        { src: "./assets/portfolio-canopy-evening.jpg", alt: "Двускатный навес для двух автомобилей" }
      ],
    ...
    "canopy-bbq": {
      ...
      gallery: [
        { src: "./assets/portfolio-canopy-evening.jpg", alt: "Навес для зоны барбекю" },
        { src: "./assets/hero-canopy-evening.jpg", alt: "Крытая зона отдыха у дома" },
        { src: "./assets/canopy.webp", alt: "Металлический навес на участке" }
      ],
    ...
    "canopy-half-arch": {
      ...
      gallery: [
        { src: "./assets/hero-canopy-evening.jpg", alt: "Полуарочный навес у дома" },
        { src: "./assets/canopy.webp", alt: "Пристенный металлический навес" },
        { src: "./assets/portfolio-canopy-evening.jpg", alt: "Навес над террасой" }
      ],
    ...
    "canopy-flat": {
      ...
      gallery: [
        { src: "./assets/portfolio-canopy-blue.jpg", alt: "Прямой навес у дома" },
        { src: "./assets/hero-canopy-evening.jpg", alt: "Современный металлический навес" },
    ...
    "canopy-soft-roof": {
      ...
      gallery: [
        { src: "./assets/portfolio-canopy-evening.jpg", alt: "Навес с мягкой кровлей у дома" },
        { src: "./assets/hero-canopy-evening.jpg", alt: "Крытый навес рядом с коттеджем" },
        { src: "./assets/portfolio-canopy-blue.jpg", alt: "Металлический навес со скатной кровлей" }
      ],
